...
export default function FooterCom() {
  return (
    <Footer container className='border border-t-8 border-green-900'>
            ...
            <div className='grid w-full justify-between sm:flex md:grid-cols-1' >
                ...
                <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
                    ...
                    <div>
                        ...
                        <Footer.LinkGroup col>
                            <Footer.Link href='https://www.github.com/nandini-patel-mnnit' target='_blank' rel='noopener noreferrer' >
                                GitHub
                            </Footer.Link>
                            <Footer.Link href='#' >
                                Discord
